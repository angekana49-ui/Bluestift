        ...
        <div style={{ position: "relative", zIndex: 1, paddingTop: 140, paddingBottom: 24 }}>
          ...
          {view === "landing" && (
            <div style={{ maxWidth: 560, margin: "0 auto", padding: "0 24px 40px", textAlign: "center" }}>
              ...
              <h1 style={{ fontFamily: "var(--font-plex),'IBM Plex Sans',sans-serif", fontWeight: 900, fontSize: "clamp(1.6rem,4vw,2.4rem)", letterSpacing: "-0.02em", lineHeight: 1.2, margin: "0 0 14px", color: t.text }}>
                Do you teach or do you learn?
                <br />
                <em style={{ fontFamily: "var(--font-instrument-serif),'Instrument Serif',serif", fontStyle: "italic", color: t.orange }}>Tell us what&apos;s really getting in the way.</em>
              </h1>
