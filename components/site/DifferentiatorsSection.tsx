    ...
    <section style={{ position: "relative", background: t.cardBg, padding: "96px 24px" }}>
      ...
      <div style={{ position: "relative", maxWidth: 720, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 44 }}>
          ...
          <p style={{ fontSize: 16, color: t.text, marginTop: 12 }}>The difference isn&apos;t the AI. It&apos;s the memory.</p>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14, border: `1px solid ${t.diffRowBorder}`, background: t.diffRowBg, borderRadius: 16, padding: "16px 20px" }}>
            ...
            <span style={{ fontSize: 15, fontWeight: 600, color: t.diffStrong }}>Raya</span>
            <span style={{ fontSize: 14, color: t.diffSoft }}>— Remembers. Adapts. Measures. And learns from you.</span>
          </div>
        </div>
      </div>
    </section>
