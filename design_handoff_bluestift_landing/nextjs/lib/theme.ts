// BlueStift theme tokens — single source of truth, Home's (richer) light palette
// used as the canonical light variant per the design handoff. Import this
// instead of re-deriving colors per component.
