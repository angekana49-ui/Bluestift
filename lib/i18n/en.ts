...
export const en = {
  ...
  "onb.path.schools.badge": "Email account required",
  "onb.path.schools.gateTitle": "Schools needs an account with an email",
  "onb.path.schools.gateBody":
    "You're signed in without an email. Schools is for teachers and school staff, whose accounts must be recoverable, so it needs a real email. Raya works fine without one.",
  "onb.path.schools.gateRaya": "Continue with Raya",
  "onb.path.schools.gateEmail": "Sign in with an email",
  ...
  "onb.srole.teacher.desc": "Join your school's team with an invite code, or ask your school directly.",
  "onb.srole.school.title": "I run a school",
  "onb.srole.school.desc": "Set up your school and start a free 45-day pilot.",
  ...
  "room.invite.copied": "Copied ✓",
  "room.invite.linkLabel": "Invite link",
  "room.invite.shareText": "Join my study room on Raya",
  "room.invite.privateNote": "The room stays private — only people you send the link to can get in.",
  "room.invite.dismiss": "Hide",
  "room.invite.panelTitle": "Invite",
  ...
  "school.billing.pilotAccessCapped": "— new students are accepted up to your pilot headcount.",
  "school.billing.pilotSeatsLabel": "Pilot headcount:",
  "school.billing.pilotSeatsChange": "Change",
  "school.billing.pilotSeatsSave": "Save",
  "school.billing.pilotSeatsHint": "Students can join up to this number during the pilot. Raise it whenever you need to — nothing is charged.",
  "school.billing.pilotSeatsMinA": "Enter at least",
  "school.billing.pilotSeatsMinB": "students (the minimum, and never fewer than those already enrolled).",
  "school.billing.pilotSeatsFailed": "Couldn't update the headcount.",
  "school.billing.pilotSeatsReached": "Your pilot headcount is reached — new students can't join until you raise it below.",
  ...
  // ---- The layer between onboarding and Schools (/school/enter) ----
  "layer.switch.toTeacher": "I'm joining a school instead",
  "layer.switch.toAdmin": "I'm setting up a school instead",
  "layer.err.generic": "Something went wrong. Please try again.",
  "layer.err.network": "Couldn't reach the server. Check your connection and try again.",
  "layer.school.heading": "Set up your school",
  "layer.school.sub": "Tell us about your school, then choose the plan your free pilot runs on. Nothing is charged today.",
  "layer.school.logo": "School logo",
  "layer.school.logoAdd": "Add a logo",
  "layer.school.logoChange": "Change logo",
  "layer.school.logoHint": "JPG, PNG or WebP, up to 5 MB. Optional.",
  "layer.school.logoTooBig": "That image is over 5 MB.",
  "layer.school.logoType": "Choose a JPG, PNG or WebP image.",
  "layer.school.name": "School name",
  "layer.school.namePlaceholder": "e.g. Victor Hugo High School",
  "layer.school.type": "Type of school",
  "layer.school.typeNone": "Select…",
  "layer.school.country": "Country",
  "layer.school.countryNone": "Select a country…",
  "layer.school.city": "City",
  "layer.school.phone": "Phone",
  "layer.school.email": "School email",
  "layer.school.emailPlaceholder": "contact@yourschool.org",
  "layer.school.adminEmail": "Admin email",
  "layer.school.adminEmailHint": "Your account's email. Join requests and receipts are sent here.",
  ...
  "layer.plans.subB":
    "-day pilot of the plan you choose. After that, activate it from Billing to keep adding students and classes.",
  "layer.plans.students": "How many students does your school have?",
  "layer.plans.minA": "At least",
  "layer.plans.minB": "students. New students are accepted up to this number during your pilot — you can raise it later in Billing.",
  "layer.plans.minErrorA": "Enter at least",
  "layer.plans.minErrorB": "students.",
  "layer.plans.pilotDays": "-day free pilot",
  "layer.plans.studentsWord": "students",
  "layer.plans.nothingToday": "nothing charged today",
  "layer.plans.after": "After the pilot:",
  "layer.plans.perMonth": "/ month",
  "layer.plans.or": "or",
  "layer.plans.perYear": "/ year with the 15% annual discount",
  "layer.plans.startA": "Start my ",
  "layer.plans.startB": "-day pilot",
  "layer.plans.starting": "Starting your pilot…",
  "layer.plans.unavailable": "Plans are unavailable right now. Please try again shortly.",
  "layer.plans.pickPrompt": "Choose a plan above to see the terms of your pilot.",
  "layer.plans.unavailableBadge": "Not available yet",
  "layer.plans.contactTeam": "Contact the team",
  "plan.feature.standard.0": "Everything students get (Raya, profile, Tools)",
  "plan.feature.standard.1": "Teacher dashboards",
  "plan.feature.standard.2": "ClassView (roster + risk)",
  "plan.feature.standard.3": "Class insights & reports",
  "plan.feature.plus.0": "Everything in Standard",
  "plan.feature.plus.1": "School-wide overview & analytics",
  "plan.feature.plus.2": "Raya for Schools",
  "plan.feature.plus.3": "What-if simulations & directives",
  "plan.feature.plus.4": "LMS sync (Google Classroom, …)",
  "plan.feature.custom.0": "Everything in Plus",
  "plan.feature.custom.1": "SSO & dedicated support / SLA",
  "plan.feature.custom.2": "Custom integrations",
  "plan.feature.custom.3": "Data region & privacy options",
  "plan.feature.custom.4": "Curriculum alignment & staff training",
  "layer.allSet.title": "You're all set.",
  "layer.allSet.schoolBody": "is on Bluestift Schools. Your free pilot runs until",
  "layer.allSet.logoFailed": "Your logo didn't upload — you can add it any time in Settings.",
  "layer.allSet.openSchool": "Open my school →",
  "layer.teacher.heading": "Join your school",
  ...
  "layer.teacher.join": "Join my school",
  "layer.teacher.joining": "Joining…",
  "layer.teacher.noCode": "No code?",
  "layer.teacher.askTitle": "Ask your school",
  "layer.teacher.askSub":
    "Enter your school's email or your administrator's. If a school on Bluestift matches, its admin receives your request.",
  "layer.teacher.askPlaceholder": "admin@yourschool.org",
  "layer.teacher.askSend": "Send my request",
  "layer.teacher.sending": "Sending…",
  "layer.teacher.joinedBody": "You're now on the team at",
  "layer.teacher.openDashboard": "Open my dashboard →",
  "layer.teacher.requestedTitle": "Request sent.",
  "layer.teacher.requestedBodyA": "Your request to join",
  "layer.teacher.requestedBodyB": "is waiting for the admin's approval. We'll email you as soon as it's decided.",
  "layer.teacher.askedBody":
    "If a school on Bluestift matches that address, its admin now has your request. We'll email you once it's approved.",
  "layer.teacher.goRaya": "Continue to Raya meanwhile →",
  "layer.email.heading": "Schools needs an email account",
  "layer.email.body":
    "Schools accounts belong to teachers and school staff, so they need a verified email. Add one to your account, then come back.",
  "layer.email.add": "Add my email",
  "layer.email.raya": "Continue with Raya",
} as const;
