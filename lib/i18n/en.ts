...
export const en = {
  ...
  "onb.err.usernameShort": "Your username needs at least 3 characters.",
  "onb.err.displayShort": "Your display name needs at least 3 characters.",
  "onb.err.usernameTakenHint": "Try a variation: add a number, an initial or your city.",
  ...
  "auth.account.statusLabel": "Account status",
  "auth.account.status.anonymous": "Anonymous",
  "auth.account.status.anonymousHint": "No email linked: your recovery key is the only way back into this account.",
  "auth.account.status.unverified": "Email not confirmed",
  "auth.account.status.unverifiedHint": "Open the link we emailed you to confirm this address.",
  "auth.account.status.verified": "Verified",
  "auth.account.status.verifiedHint": "Your email address is confirmed.",
  // ── Anonymous → verified (lib/account-upgrade.ts): the form, the link page,
  //    and the email, which is written in the requester's language ──
  "upgrade.pwLabel": "Password",
  "upgrade.pwHint": "You'll sign in with this email and password. Your recovery key keeps working too.",
  "upgrade.submit": "Verify my account",
  "upgrade.verifiedBadge": "Verified ✓",
  "upgrade.checkInbox.a": "We sent a link to",
  "upgrade.checkInbox.b": "Open it on any device to finish — you can carry on here meanwhile.",
  "upgrade.changeAddress": "Wrong address?",
  "upgrade.doneHere": "Your account is verified. Everything in it is still here.",
  "upgrade.confirmedHere": "Email confirmed — your account is verified.",
  "upgrade.err.emailInvalid": "That doesn't look like an email address.",
  "upgrade.err.emailTaken": "This email already has a Bluestift account.",
  "upgrade.err.emailTakenHint": "Use another address, or sign in to that account instead.",
  "upgrade.err.alreadyVerified": "This account already has an email.",
  "upgrade.err.rateLimited": "Too many attempts today. Try again tomorrow.",
  "upgrade.err.emailFailed": "We couldn't send the email. Check the address and try again.",
  "upgrade.err.unavailable": "Something went wrong on our side. Try again in a moment.",
  "upgrade.err.network": "Can't reach the server. Check your connection.",
  "upgrade.confirm.heading": "Confirm your email",
  "upgrade.confirm.sub.a": "This adds",
  "upgrade.confirm.sub.b": "to your Bluestift account. Everything in it stays exactly as it is.",
  "upgrade.confirm.button": "Confirm and continue",
  "upgrade.confirm.doneHeading": "Your account is verified",
  "upgrade.confirm.doneSub": "Your conversations, tests and progress are all still here. From now on you can sign in with your email and password — and your recovery key still works.",
  "upgrade.confirm.continue": "Continue",
  "upgrade.confirm.signIn": "Sign in",
  "upgrade.confirm.back": "Back to Bluestift",
  "upgrade.confirm.keyNote": "Your recovery key keeps working after this.",
  "upgrade.confirm.err.invalid": "This link can't be used.",
  "upgrade.confirm.err.expired": "This link has expired.",
  "upgrade.confirm.err.emailTaken": "This email was added to another Bluestift account in the meantime.",
  "upgrade.confirm.err.alreadyVerified": "This account already has a different email.",
  "upgrade.confirm.err.retryHint": "Ask for a new link from Settings, on the device where you use Bluestift.",
  "upgrade.confirm.err.signInHint": "Sign in with that email, or with your recovery key.",
  "upgrade.confirm.err.laterHint": "Try again in a moment — the link stays valid.",
  "email.upgrade.subject": "Confirm your email for Bluestift",
  "email.upgrade.heading": "One tap to verify your account",
  "email.upgrade.line1": "You asked to add this address to your Bluestift account. Everything in it stays exactly as it is.",
  "email.upgrade.line2": "The link works for 24 hours, on any device.",
  "email.upgrade.line3": "Didn't ask for this? Ignore this email — nothing will change.",
  "email.upgrade.cta": "Confirm my email",
  ...
  // `api.*` is what a route or server action hands back as `{ error }`, which
  // the browser shows as-is; `email.*` the mail those routes send. Translated
  // on the server from the locale cookie (lib/i18n/server.ts → apiT). `{name}`
  // placeholders are filled by `fill()` — keep every one of them in a translation.
  "api.enterTheYearYouWereBorn": "Enter the year you were born.",
  "api.yourAgeIsAlreadyOnFile": "Your age is already on file. Contact support if it needs correcting.",
  "api.yourProfileCouldNotBeFound": "Your profile could not be found.",
  "api.typeToConfirm": "Type {confirm} to confirm.",
  "api.tooManyAttemptsTryAgainShortly": "Too many attempts — try again shortly.",
  "api.youveRequestedSeveralExportsRecentlyTry": "You've requested several exports recently — try again shortly.",
  "api.tooManyTriesWaitAnHour": "Too many tries. Wait an hour and try again.",
  "api.thatsNotTheWordOnThis": "That's not the word on this account.",
  "api.chooseAWordOfAtLeast": "Choose a word of at least {keywordMinLength} letters you'll remember.",
  "api.tooManyNewKeysTodayTry": "Too many new keys today — try again tomorrow.",
  "api.couldNotGenerateAKey": "Could not generate a key.",
  "api.yourKeyIsActiveButWe": "Your key is active, but we couldn't save your word — set it by generating again.",
  "api.yourNewKeyIsActiveBut": "Your new key is active, but you'll need to sign in again with it.",
  "api.thisOptionIsntAvailableOnAccounts": "This option isn't available on accounts belonging to under-18s.",
  "api.assignmentNotForYou": "This assignment isn't for you.",
  "api.assignmentDeadlinePassed": "The deadline for this assignment has passed.",
  "api.assignmentAlreadySubmitted": "You've already submitted this assignment.",
  "api.assignmentHasNoQuestions": "assignment has no questions",
  "api.accountCreationIsTemporarilyUnavailablePlease": "Account creation is temporarily unavailable. Please try again later.",
  "api.couldNotFinalizeTheSession": "Could not finalize the session.",
  "api.planRequired": "A plan is required.",
  "api.thisAccountBelongsToSomeoneUnder": "This account belongs to someone under 18. A parent or guardian has to confirm they are the one paying.",
  "api.onlinePaymentsArentConfiguredYet": "Online payments aren't configured yet.",
  "api.unsupportedPaymentMethod": "Unsupported payment method.",
  "api.planUnknown": "Unknown or inactive plan.",
  "api.planDoesNotMatchTheSelected": "Plan does not match the selected audience.",
  "api.onlyTheSchoolAdminCanPay": "Only the school admin can pay for the school.",
  "api.thisPlanIsQuotedNotSold": "This plan is quoted, not sold online — talk to the team.",
  "api.thisPlanIsFreeNoPayment": "This plan is free — no payment needed.",
  "api.contractSeatsRequired": "Enter the number of students to contract.",
  "api.couldNotStartCheckout": "Could not start checkout.",
  "api.thisMethodIsntAvailableForOnline": "This method isn't available for online checkout.",
  "api.couldNotReachThePaymentProvider": "Could not reach the payment provider. Try again.",
  "api.noAttemptToAnalyseYet": "No attempt to analyse yet.",
  "api.analysisFailed": "analysis failed",
  "api.provideANameAGoalA": "Provide a name, a goal, a topic, or a source file.",
  "api.roomMemberOnly": "You must be a room member.",
  "api.roomEnded": "This room has ended — it's now read-only.",
  "api.theRoomHasNoRecentDiscussion": "The room has no recent discussion to build from yet — add a topic, a goal, or a source file.",
  "api.generationFailed": "generation failed",
  "api.notFound": "not found",
  "api.thisIsAClassAssignmentNot": "This is a class assignment, not a personal test — archive it instead of deleting it.",
  "api.challengeHasNoQuestions": "challenge has no questions",
  "api.nothingToTranslate": "nothing to translate",
  "api.documentTooLongToTranslate": "document too long to translate",
  "api.tooManyTranslationsJustNowTry": "Too many translations just now — try again shortly.",
  "api.aSchoolIdIsRequired": "A school id is required.",
  "api.aUserEmailIsRequired": "A user email is required.",
  "api.noAccountWithEmail": "No account with that email.",
  "api.emptyMessage": "empty message",
  "api.chatTooFast": "You're sending messages very fast — give it a second.",
  "api.chatDailyCeiling": "You've hit today's message ceiling. It resets over the next 24 hours.",
  "api.youAreNotAMemberOf": "You are not a member of this room.",
  "api.conversationNotFound": "conversation not found",
  "api.llmError": "llm error",
  "api.fileRequired": "file required",
  "api.thisRoomIsUnavailable": "This room is unavailable.",
  "api.noAudio": "no audio",
  "api.transcriptionError": "transcription error",
  "api.noMessagesYet": "no messages yet",
  "api.notEnoughActivityToReportOn": "Not enough activity to report on.",
  "api.staffOnly": "School staff only.",
  "api.tooManyAlertsInOneCall": "Too many alerts in one call.",
  "api.alertNotFound": "Alert not found.",
  "api.notYourStudent": "Not your student.",
  "api.yearNotFound": "Year not found.",
  "api.adminOnly": "Admin only.",
  "api.unknownProf": "Unknown prof.",
  "api.unknownClass": "Unknown class.",
  "api.unknownSubject": "Unknown subject.",
  "api.thatProfIsAlreadyAssignedTo": "That prof is already assigned to this class + subject.",
  "api.billingAdminOnly": "Only the school admin can manage billing.",
  "api.onlyTheSchoolAdminCanAdd": "Only the school admin can add classes.",
  "api.noSchoolAdministered": "You don't administer a school.",
  "api.yourPilotHasEndedActivateA": "Your pilot has ended. Activate a plan in Billing to add classes again.",
  "api.classNameRequired": "A class name is required.",
  "api.classNameTaken": "A class with that name already exists this year.",
  "api.onlyTheSchoolAdminCanEdit": "Only the school admin can edit classes.",
  "api.classNotFound": "Class not found.",
  "api.thisClassBelongsToAnArchived": "This class belongs to an archived year. Past years are a record and can't be changed.",
  "api.thisClassIsStillReferencedElsewhere": "This class is still referenced elsewhere and can't be removed.",
  "api.notYourClass": "Not your class.",
  "api.couldNotAllocateACode": "Could not allocate a code.",
  "api.codeNotFound": "Code not found.",
  "api.thisCodeWasReplacedAndCan": "This code was replaced and can no longer be reactivated.",
  "api.notYourCode": "Not your code.",
  "api.addAVerifiedEmailBeforeCreating": "Add a verified email before creating a school — staff accounts need one. You can link it in Settings.",
  "api.youveCreatedSeveralSchoolsTodayPlease": "You've created several schools today. Please try again tomorrow.",
  "api.theSchoolNameNeedsAtLeast": "The school name needs at least {minNameLength} characters.",
  "api.chooseTheSchoolsCountry": "Choose the school's country.",
  "api.enterTheSchoolsCity": "Enter the school's city.",
  "api.theSchoolEmailDoesntLookRight": "The school email doesn't look right.",
  "api.declareHowManyStudentsTheSchool": "Declare how many students the school has — at least {minB2bSeats}.",
  "api.chooseAPlanForYourPilot": "Choose a plan for your pilot.",
  "api.youAlreadyHaveInOpenIt": "You already have {name} in {city}. Open it from your schools instead of creating it again.",
  "api.directiveTextIsRequired": "Directive text is required.",
  "api.directiveNotFound": "Directive not found.",
  "api.aStudentAndNoteTextAre": "A student and note text are required.",
  "api.unknownStudentForThisClass": "Unknown student for this class.",
  "api.noteNotFound": "Note not found.",
  "api.aClassAndInstructionTextAre": "A class and instruction text are required.",
  "api.youAreNotAssignedToThis": "You are not assigned to this subject.",
  "api.instructionNotFound": "Instruction not found.",
  "api.couldNotAllocateAUniqueCode": "Could not allocate a unique code, try again.",
  "api.aClassCodeIsRequired": "A class code is required.",
  "api.firstAndLastNameAreRequired": "First and last name are required.",
  "api.invalidOrInactiveClassCode": "Invalid or inactive class code.",
  "api.thatClassNoLongerExists": "That class no longer exists.",
  "api.thisClassIsFullAskYour": "This class is full — ask your teacher for another class or code.",
  "api.thisSchoolIsntAcceptingNewStudents": "This school isn't accepting new students right now — ask your school administrator.",
  "api.thisSchoolHasReachedItsSeat": "This school has reached its seat limit — ask your school administrator to add seats.",
  "api.addAVerifiedEmailBeforeJoining": "Add a verified email before joining a school as a teacher. You can link it in Settings.",
  "api.aCodeIsRequired": "A code is required.",
  "api.invalidOrInactiveCode": "Invalid or inactive code.",
  "api.googleClassroomIsNotConnected": "Google Classroom is not connected.",
  "api.sessionExpiredReconnectGoogleClassroom": "Session expired — reconnect Google Classroom.",
  "api.refreshFailed": "refresh failed",
  "api.syncFailed": "sync failed",
  "api.unknownConnection": "Unknown connection.",
  "api.mappingNotFound": "Mapping not found.",
  "api.notYours": "Not yours.",
  "api.unknownLmsProvider": "Unknown LMS provider.",
  "api.connectionNotFound": "Connection not found.",
  "api.onlyTheSchoolAdminCanChange": "Only the school admin can change the logo.",
  "api.pleaseChooseAnImage": "Please choose an image.",
  "api.invalidImageFile": "Invalid image file.",
  "api.aResourceAndAClassAre": "A resource and a class are required.",
  "api.invalidDueDate": "Invalid due date.",
  "api.theDueDateIsInThe": "The due date is in the past.",
  "api.resourceNotFound": "Resource not found.",
  "api.thisResourceHasNoUsableQuestions": "This resource has no usable questions to assign.",
  "api.assignmentNotFound": "Assignment not found.",
  "api.subjectNotFoundOrNotYours": "Subject not found or not yours.",
  "api.theModelReturnedNoUsableQuestions": "The model returned no usable questions.",
  "api.thisResourceIsTiedToA": "This resource is tied to a class and part of the year record — archive it instead of deleting it.",
  "api.noData": "No data.",
  "api.teacherEmailRequired": "Enter the teacher's email address.",
  "api.tooManyLookupsTryAgainShortly": "Too many lookups — try again shortly.",
  "api.youveCreatedManyTeacherAccountsToday": "You've created many teacher accounts today. Please try again tomorrow.",
  "api.thatEmailAlreadyHasAnAccount": "That email already has an account. Share an invite code with them instead.",
  "api.couldNotCreateTheAccount": "Could not create the account.",
  "api.couldNotAddTheTeacher": "Could not add the teacher.",
  "api.thatUserIsAlreadyInYour": "That user is already in your school.",
  "api.teacherNotFound": "Teacher not found.",
  "api.noSchoolDataAvailableForYou": "No school data available for you yet.",
  "api.adminOnlyForThisScope": "Admin only for this scope.",
  "api.classNotFoundOrNotYours": "Class not found or not yours.",
  ...
  "api.onlyTheSchoolAdminCanEdit2": "Only the school admin can edit school info.",
  "api.theSchoolsCityCantBeEmpty": "The school's city can't be empty.",
  "api.invalidSchoolType": "Invalid school type.",
  "api.nothingToUpdate": "Nothing to update.",
  "api.noAccessToThatClass": "No access to that class.",
  "api.projectionFailed": "projection failed",
  "api.notFoundOrNotYours": "Not found or not yours.",
  "api.aSubjectNameIsRequired": "A subject name is required.",
  "api.couldNotStartTheYear": "Could not start the year.",
  "api.nothingToShare": "nothing to share",
  "api.noFile": "no file",
  "api.unsupportedFileUseTextTxtMd": "Unsupported file. Use text (.txt/.md), PDF, or audio.",
  "api.extractionFailed": "extraction failed",
  "api.noTextCouldBeExtractedFrom": "No text could be extracted from this file.",
  "api.thisToolIsComingSoonAvailable": "This tool is coming soon. Available: quiz, summary.",
  "api.emptySourceText": "empty source text",
  "api.roomNameIsRequired": "Room name is required.",
  "api.notSignedIn": "Not signed in.",
  "api.roomNotFound": "Room not found.",
  "api.onlyTheRoomsCreatorCanChange": "Only the room's creator can change this.",
  "api.roomPrivateMinor": "This room stays private: it has a member under 18.",
  "api.thisRoomIsPublicRoomsThat": "This room is public. Rooms that include a member under 18 stay private — ask for an invite link instead.",
  "api.aSchoolIsRequired": "A school is required.",
  "api.youreNotAMemberOfThat": "You're not a member of that school.",
  "api.enterAWholeNumberOfStudents": "Enter a whole number of students.",
  "api.yourSchoolHasNoRunningPilot": "Your school has no running pilot.",
  "api.enterAtLeastStudents": "Enter at least {floor} students.",
  "api.couldNotUpdateTheHeadcount": "Could not update the headcount.",
  "api.planActivateFailed": "Could not activate the plan.",
  "api.thatsASchoolPlanActivateIt": "That's a school plan — activate it on a school, not a user.",
  "api.thatsAnIndividualPlanActivateIt": "That's an individual plan — activate it on a user, not a school.",
  "api.tellUsTheYearYouWere": "Tell us the year you were born before using Raya.",
  "api.finishOnboardingBeforeUsingThis": "Finish onboarding before using this.",
  "api.contractAtLeastEnrolled": "Contract at least {floor} seats — your school already has {headcount} students enrolled.",
  "api.contractAtLeastEnrolledThisSchool": "Contract at least {floor} seats — this school already has {headcount} students enrolled.",
  "api.contractAtLeastMinimum": "Contract at least {floor} seats — the minimum contract is {min} students.",
  "api.deletionPartlyFailed": "We removed most of your data but part of the deletion failed. Write to hello@thebluestift.com and we'll finish it by hand.",
  "api.anonSessionFailed": "Could not start an anonymous session.",
  "api.alertsPartlyAcknowledged": "Some alerts were not acknowledged. Refresh to see the current state.",
  "api.alertsKernelUnreachable": "Could not reach the kernel — nothing was acknowledged. Try again.",
  "api.assignmentCreateFailed": "Could not create the assignment.",
  "api.invitationCreateFailed": "Could not create the invitation.",
  "api.gradingUnavailable": "Automatic grading was unavailable for this answer.",
  "api.classHasStudentsOne": "This class has {count} student. Remove them first, or leave it — it is archived automatically at the end of the year.",
  "api.classHasStudentsMany": "This class has {count} students. Remove them first, or leave it — it is archived automatically at the end of the year.",
  "api.fileTooLarge": "File too large (max {mb} MB).",
  "api.metric.rooms": "rooms",
  "api.metric.roomParticipants": "room participants",
  "api.metric.generations": "generations",
  "api.metric.uploads": "uploads",
  "api.metric.whatIfSimulations": "what-if simulations",
  "api.metric.exports": "exports",
  "api.metric.messages": "messages",
  "api.metric.privateSessions": "private sessions with Raya",
  "api.metric.simulations": "simulations",
  "api.metric.roomChallenges": "room challenges",
  "api.metric.reports": "reports",
  "api.metric.prepareGenerations": "Prepare generations",
  "api.metric.aiGradedAssignments": "AI-graded assignments",
  "api.gate.quotaDay": "You've reached your {metric} limit today ({limit}).",
  "api.gate.quotaWeek": "You've reached your {metric} limit this week ({limit}).",
  "api.gate.quotaMonth": "You've reached your {metric} limit this month ({limit}).",
  "api.gate.quota": "You've reached your {metric} limit ({limit}).",
  "api.gate.upgradeTo": "Upgrade to {plan} for more.",
  "api.gate.upgradeHigher": "Upgrade to a higher plan for more.",
  "api.gate.featureRequires": "This feature requires {plan}.",
  "api.gate.featureUpgrade": "This feature requires an upgrade.",
  "api.notif.joinRequestTitle": "Teacher join request",
  "api.notif.joinRequestDetail": "{name} asked to join your school.",
  "api.notif.atRiskOne": "{count} student at risk",
  "api.notif.atRiskMany": "{count} students at risk",
  "api.notif.activeLastWeek": "{count} active over the last 7 days.",
  "api.notif.needsAttention": "{name} needs attention",
  "email.joinApproved.subject": "You've joined {school}",
  "email.joinApproved.line1": "Your request to join {school} on Bluestift Schools was approved.",
  "email.joinApproved.line2": "You can now open the school dashboard and start working with your classes.",
  "email.joinApproved.cta": "Open your dashboard",
  "email.joinDeclined.subject": "Your request to {school}",
  "email.joinDeclined.heading": "Update on your request to {school}",
  "email.joinDeclined.line1": "Your request to join {school} on Bluestift Schools wasn't approved this time.",
  "email.joinDeclined.line2": "If you think this is a mistake, reach out to your school administrator.",
  "email.planActive.yourPlan": "Your plan",
  "email.planActive.subject": "{plan} is active — {school}",
  "email.planActive.heading": "{plan} is active",
  "email.planActive.line1": "{plan} is now active for {school} on Bluestift Schools.",
  "email.planActive.amount": "Amount recorded: {amount}.",
  "email.planActive.until": "Your subscription runs until {date}.",
  "email.planActive.cta": "View billing",
  "email.teacherInvite.subject": "{school} invited you to join them on Bluestift",
  "email.teacherInvite.heading": "{school} invited you",
  "email.teacherInvite.hiName": "Hi {name},",
  "email.teacherInvite.hi": "Hi there,",
  "email.teacherInvite.line1": "{school} has invited you to join their team on Bluestift Schools as a teacher.",
  "email.teacherInvite.line2": "Open Schools and enter this code to accept: {code}",
  "email.teacherInvite.line3": "If you weren't expecting this, you can ignore it — nothing changes on your account unless you enter the code.",
  "email.teacherInvite.cta": "Accept the invitation",
  "email.joinRequest.yourSchool": "your school",
  "email.joinRequest.subject": "New request to join {school}",
  "email.joinRequest.line1Email": "{who} asked to join {school} on Bluestift Schools and is waiting for your approval.",
  "email.joinRequest.line1": "A teacher asked to join {school} on Bluestift Schools and is waiting for your approval.",
  "email.joinRequest.line2": "Open the Team page to approve or decline the request.",
  "email.joinRequest.cta": "Review requests",
  "voice.transcriptionPrefix": "Transcription:",
  "voice.couldNotTranscribe": "Could not transcribe.",
  "voice.couldNotTranscribeSaved": "Could not transcribe — your recording is saved.",
  ...
  "room.memberCountOne": "{count} member",
  "room.memberCountMany": "{count} members",
  "room.helloMessage": "Hi everyone",
  "room.startOnMessage": "Let's start on {subject}",
  "rooms.defaultName": "{subject} study room",
  "doc.generatedBy": "Generated by {name} · © {year} Bluestift",
  "doc.generatedByFor": "Generated by {name} for {audience} · © {year} Bluestift",
  "doc.roomAudience": "{room} room",
  "doc.report.title": "{room} — session report",
  "doc.report.squadScore": "Squad score",
  "doc.report.summary": "Summary",
  "doc.report.keyLearnings": "Key learnings",
  "doc.report.highlights": "Highlights",
  "doc.report.recommendations": "Recommendations",
  "doc.resultTitle": "{title} — result",
  "doc.challengeResult": "Challenge result",
  "plan.chip.free": "Free",
