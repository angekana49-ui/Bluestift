...
export default function NavbarControls({ links, active }: { links: NavLink[]; active?: string }) {
  ...
  return (
    <>
      ...
      >
        <span
          className="absolute top-[3px] flex h-[26px] w-[26px] items-center justify-center rounded-full shadow-[0_4px_12px_rgba(15,23,42,0.2)] transition-all duration-350"
          style={{
            left: isDay ? "3px" : "35px",
